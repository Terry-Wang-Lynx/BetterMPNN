...
PATH_TO_MODEL_WEIGHTS = os.path.join(os.path.dirname(__file__), '../vanilla_model_weights/v_48_XXX.pt')
# If you want to use soluble_model_weights, please change the directory of model, such as:
# PATH_TO_MODEL_WEIGHTS = os.path.join(os.path.dirname(__file__), '../soluble_model_weights/v_48_XXX.pt')
