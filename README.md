...
### First-round Wet Lab Validation Results

We conducted wet lab validation using SPR on the first batch of results randomly selected from the Final Sequence Pool without virtual screening.

The results indicate **a hit rate of approximately 83%** for effective binding, with over half of the binders demonstrating micromolar-level affinity metrics.
